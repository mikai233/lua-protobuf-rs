...
impl LuaProtoCodec {
    ...
    pub fn decode_message<'a>(&self, message: &dyn MessageDyn, lua: &'a Lua) -> anyhow::Result<Table<'a>> {
    ...
    pub fn unbox_value<'a>(&self, message_name: &str, field_name: &str, value: ReflectValueRef, lua: &'a Lua) -> anyhow::Result<LuaValue<'a>> {
