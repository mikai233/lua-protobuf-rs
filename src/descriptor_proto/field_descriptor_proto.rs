...
impl LuaUserData for LuaFieldDescriptorProto {
    fn add_fields<F: UserDataFields<Self>>(fields: &mut F) {
        ...
        fields.add_field_method_get("label", |_, this| {
            Ok(this.label.as_ref().map(|e| e.enum_value_or_default() as i32))
        });

        fields.add_field_method_get("type_", |_, this| {
            Ok(this.type_.as_ref().map(|e| e.enum_value_or_default() as i32))
        });

        fields.add_field_method_get("type_name", |_, this| {
            Ok(this.type_name.clone())
        });

        fields.add_field_method_get("extendee", |_, this| {
            Ok(this.extendee.clone())
        });

        fields.add_field_method_get("default_value", |_, this| {
            Ok(this.default_value.clone())
        });

        fields.add_field_method_get("oneof_index", |_, this| {
            Ok(this.oneof_index)
        });

        fields.add_field_method_get("json_name", |_, this| {
            Ok(this.json_name.clone())
        });

        fields.add_field_method_get("options", |_, this| {
            let options: Option<LuaFieldOptions> = this.options.clone().into_option().map(Into::into);
            Ok(options)
        });

        fields.add_field_method_get("proto3_optional", |_, this| {
            Ok(this.proto3_optional)
        });
    }
    ...
    fn add_methods<M: UserDataMethods<Self>>(methods: &mut M) {
        ...
        methods.add_method("has_number", |_, this, ()| {
            Ok(this.has_number())
        });
        ...
        methods.add_method("has_label", |_, this, ()| {
            Ok(this.has_label())
        });
        ...
        methods.add_method("type_", |_, this, ()| {
            Ok(this.type_() as i32)
        });

        methods.add_method("has_type", |_, this, ()| {
            Ok(this.has_type())
        });
        ...
        methods.add_method("has_type_name", |_, this, ()| {
            Ok(this.has_type_name())
        });
        ...
        methods.add_method_mut("take_type_name", |_, this, ()| {
            Ok(this.take_type_name())
        });

        methods.add_method("extendee", |_, this, ()| {
            Ok(this.extendee().to_string())
        });

        methods.add_method("has_extendee", |_, this, ()| {
            Ok(this.has_extendee())
        });
        ...
        methods.add_method_mut("take_extendee", |_, this, ()| {
            Ok(this.take_extendee())
        });
        ...
        methods.add_method("oneof_index", |_, this, ()| {
            Ok(this.oneof_index())
        });

        methods.add_method("has_oneof_index", |_, this, ()| {
            Ok(this.has_oneof_index())
        });
        ...
        methods.add_method("has_json_name", |_, this, ()| {
            Ok(this.has_json_name())
        });
        ...
        methods.add_method_mut("take_json_name", |_, this, ()| {
            Ok(this.take_json_name())
        });

        methods.add_method("proto3_optional", |_, this, ()| {
            Ok(this.proto3_optional())
        });
