...
impl LuaUserData for LuaNamePart {
    fn add_fields<F: UserDataFields<Self>>(fields: &mut F) {
        fields.add_field_method_get("name_part", |_, this| Ok(this.name_part.clone()));

        fields.add_field_method_get("is_extension", |_, this| Ok(this.is_extension));
    }
    ...
    fn add_methods<M: UserDataMethods<Self>>(methods: &mut M) {
        ...
        methods.add_method_mut("take_name_part", |_, this, ()| Ok(this.take_name_part()));
        ...
        methods.add_method(
            "has_is_extension",
            |_, this, ()| Ok(this.has_is_extension()),
        );
