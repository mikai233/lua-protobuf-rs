...
impl LuaUserData for LuaFieldOptions {
    fn add_fields<F: UserDataFields<Self>>(fields: &mut F) {
        ...
        fields.add_field_method_get("packed", |_, this| Ok(this.packed));
        ...
        fields.add_field_method_get("lazy", |_, this| Ok(this.lazy));

        fields.add_field_method_get("deprecated", |_, this| Ok(this.deprecated));

        fields.add_field_method_get("weak", |_, this| Ok(this.weak));
    ...
    fn add_methods<M: UserDataMethods<Self>>(methods: &mut M) {
        ...
        methods.add_method("ctype", |_, this, ()| Ok(this.ctype() as i32));
        ...
        methods.add_method("has_ctype", |_, this, ()| Ok(this.has_ctype()));
        ...
        methods.add_method("packed", |_, this, ()| Ok(this.packed()));
        ...
        methods.add_method("has_packed", |_, this, ()| Ok(this.has_packed()));
        ...
        methods.add_method("jstype", |_, this, ()| Ok(this.jstype() as i32));
        ...
        methods.add_method("has_jstype", |_, this, ()| Ok(this.has_jstype()));
        ...
        methods.add_method("lazy", |_, this, ()| Ok(this.lazy()));
        ...
        methods.add_method("has_lazy", |_, this, ()| Ok(this.has_lazy()));
        ...
        methods.add_method("weak", |_, this, ()| Ok(this.weak()));
        ...
        methods.add_method("has_weak", |_, this, ()| Ok(this.has_weak()));
