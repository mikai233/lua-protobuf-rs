...
impl LuaUserData for LuaMethodDescriptorProto {
    fn add_fields<F: UserDataFields<Self>>(fields: &mut F) {
        ...
        fields.add_field_method_get("input_type", |_, this| {
            Ok(this.input_type.clone())
        });

        fields.add_field_method_get("output_type", |_, this| {
            Ok(this.output_type.clone())
        });

        fields.add_field_method_get("options", |_, this| {
            let options: Option<LuaMethodOptions> = this.options.clone().into_option().map(Into::into);
            Ok(options)
        });
    ...
    fn add_methods<M: UserDataMethods<Self>>(methods: &mut M) {
        ...
        methods.add_method("has_input_type", |_, this, ()| {
            Ok(this.has_input_type())
        });
        ...
        methods.add_method_mut("take_input_type", |_, this, ()| {
            Ok(this.take_input_type())
        });
        ...
        methods.add_method("has_output_type", |_, this, ()| {
            Ok(this.has_output_type())
        });
        ...
        methods.add_method_mut("take_output_type", |_, this, ()| {
            Ok(this.take_output_type())
        });

        methods.add_method("client_streaming", |_, this, ()| {
            Ok(this.client_streaming())
        });
        ...
        methods.add_method("server_streaming", |_, this, ()| {
            Ok(this.server_streaming())
        });
