...
impl LuaUserData for LuaEnumOptions {
    fn add_fields<F: UserDataFields<Self>>(fields: &mut F) {
        fields.add_field_method_get("allow_alias", |_, this| Ok(this.allow_alias));
    ...
    fn add_methods<M: UserDataMethods<Self>>(methods: &mut M) {
        ...
        methods.add_method("allow_alias", |_, this, ()| Ok(this.allow_alias()));
        ...
        methods.add_method("has_allow_alias", |_, this, ()| Ok(this.has_allow_alias()));
