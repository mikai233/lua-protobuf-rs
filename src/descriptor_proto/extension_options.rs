...
pub(crate) struct LuaExtensionRangeOptions(pub ExtensionRangeOptions);
...
impl LuaUserData for LuaExtensionRangeOptions {
    ...
    fn add_methods<M: UserDataMethods<Self>>(methods: &mut M) {
        ...
        add_message_trait_method!(methods, ExtensionRangeOptions, LuaExtensionRangeOptions);

        add_message_dyn_trait_method!(methods, ExtensionRangeOptions, LuaExtensionRangeOptions);

        add_message_full_trait_method!(methods, ExtensionRangeOptions, LuaExtensionRangeOptions);
    }
}